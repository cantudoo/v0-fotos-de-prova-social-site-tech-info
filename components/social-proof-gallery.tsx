...
const galleryItems = [
  {
    ...
    alt: "Tecnico reparando placa-mae em bancada profissional",
    caption: "Manutencao especializada de hardware",
    category: "Manutencao",
  },
  {
    src: "/images/social-proof-2.jpg",
    alt: "Consultor reunido com cliente satisfeito",
    caption: "Atendimento personalizado aos nossos clientes",
    category: "Atendimento",
  },
  {
    src: "/images/social-proof-3.jpg",
    alt: "Sala de servidores com infraestrutura moderna",
    caption: "Infraestrutura de TI de alta performance",
    category: "Infraestrutura",
  },
  {
    src: "/images/social-proof-4.jpg",
    alt: "Reparo profissional de smartphone",
    caption: "Conserto de celulares com pecas originais",
    category: "Smartphones",
  },
  {
    src: "/images/social-proof-5.jpg",
    alt: "Cliente satisfeito com sistema instalado",
    caption: "Mais um cliente satisfeito com nossas solucoes",
    category: "Resultados",
  },
  {
    src: "/images/social-proof-6.jpg",
    alt: "Instalacao de rede corporativa",
    caption: "Projeto e instalacao de redes empresariais",
    category: "Redes",
  },
]
